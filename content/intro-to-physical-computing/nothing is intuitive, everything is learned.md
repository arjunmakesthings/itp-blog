...
draft: "false"
---
[[tom-igoe|tom-igoe]] said that all interactions are learned. perhaps some things are more inviting (see: [[intro-to-physical-computing/making things that invite people to play]]) than others, and, perhaps, use similar patterns to what we've grown up using. 
...
from [[intro-to-physical-computing/no to noui, by timo arnall (against invisible design)|no to noui, by timo arnall (against invisible design)]]: 
