...
spoke about the fact that we can make workflows with [comfyui](https://www.comfy.org/), which is a node-based interface.
...
people are breaking models (like [so](https://github.com/elder-plinius/Google-Gemini-System-Prompt/blob/main/full_prompt.md)). 
